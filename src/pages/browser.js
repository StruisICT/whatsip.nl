document.addEventListener("DOMContentLoaded", function () {
  ...
  var gpuName=gpu(); // read once; the value doesn't change with language
  ...
  function render(){
    ...
    document.getElementById("grid").innerHTML=
      ...
      field(t("f.gpu"),gpuName,isFirefox?"Firefox may show outdated GPU info if your graphics card was upgraded. The WebGL cache isn't automatically refreshed. Click to open about:support for current hardware details.":null)+
